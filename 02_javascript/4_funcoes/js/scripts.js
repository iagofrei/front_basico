...
const testeBoasVindas = (name, greet = "Olá") => {
  if (!name) {
    return `${greet}, faça o cadastro no nosso site!`;
  }

  return `${greet}, ${name}!`;
};

console.log(testeBoasVindas("Iago"));

console.log(testeBoasVindas("José", "Bom dia"));

console.log(testeBoasVindas());
...
//   if (!repeat) {
//     console.error("Você não informou a quantidade de vezes que a palavra deve ser repetida!")
//   }
